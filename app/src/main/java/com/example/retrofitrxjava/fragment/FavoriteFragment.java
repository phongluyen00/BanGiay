...
public class FavoriteFragment extends BaseFragment<FragmentFavoriteBinding> implements MutilAdt.ListItemListener, ItemFavoriteListener<ProductCategories> {
